...
if menu == "🏠 Ana Sayfa":
    ...
    sevkiyat_kilavuz = """
═══════════════════════════════════════════════════════════════
              📦 SEVKİYAT MODÜLÜ KULLANIM KILAVUZU
═══════════════════════════════════════════════════════════════

🎯 AMAÇ: Mağazalara hangi ürünlerden ne kadar gönderileceğini
         hesaplamak ve SAP dosyası oluşturmak.

═══════════════════════════════════════════════════════════════
ADIM ADIM KULLANIM
═══════════════════════════════════════════════════════════════

📍 ADIM 0: VERİ YÜKLEME (Önce yapılmalı!)
───────────────────────────────────────────────────────────────
Nerede: Sol menüden "Veri Yükleme" sayfası

Ne Yapmalı:
   1. 5 zorunlu CSV dosyasını yükleyin
   2. "Veri Yükleme Durumu" tablosunda hepsi "✅ Başarılı" olmalı
   3. Sevkiyat sayfasına geri dönün

───────────────────────────────────────────────────────────────
📍 ADIM 1: SEGMENTASYON
───────────────────────────────────────────────────────────────
Nerede: Sevkiyat → "🫧 Segmentasyon"

Ne Yapmalı:
   1. "Varsayılan aralıkları kullan" kutucuğu işaretli bırakın
   2. Aşağı kaydırın
   3. "💾 Segmentasyonu Kaydet" butonuna tıklayın
   4. "✅ Ayarlar kaydedildi!" mesajını bekleyin

⏱️ Süre: 1 dakika
💡 İpucu: İlk kullanımda varsayılan değerleri değiştirmeyin!

───────────────────────────────────────────────────────────────
📍 ADIM 2: HEDEF MATRİS (Opsiyonel)
───────────────────────────────────────────────────────────────
Nerede: Sevkiyat → "🎲 Hedef Matris"

Ne Yapmalı:
   OPSİYON 1 - Varsayılanı Kullan (Önerilen):
      • Hiçbir şey yapmanıza gerek yok!
      • Direkt ADIM 3'e geçin

   OPSİYON 2 - Değiştirmek İsterseniz:
      1. Tabloda hücreye ÇİFT tıklayın
      2. Yeni değer yazın (örn: 1.2)
      3. Enter'a basın
      4. Tüm değişiklikleri yaptıktan sonra "💾 KAYDET"

⏱️ Süre: 2 dakika (değiştirirseniz)
💡 İpucu: İlk kullanımda atlayabilirsiniz!

───────────────────────────────────────────────────────────────
📍 ADIM 3: SIRALAMA (Opsiyonel)
───────────────────────────────────────────────────────────────
Nerede: Sevkiyat → "🔢 Sıralama"

Ne Yapmalı:
   OPSİYON 1 - Varsayılanı Kullan (Önerilen):
      • Hiçbir şey yapmanıza gerek yok!
      • Direkt ADIM 4'e geçin

   OPSİYON 2 - Değiştirmek İsterseniz:
      1. Dropdown'lardan öncelik seçin
...
───────────────────────────────────────────────────────────────
📍 ADIM 4: HESAPLAMA ⭐ (EN ÖNEMLİ ADIM)
───────────────────────────────────────────────────────────────
Nerede: Sevkiyat → "📐 Hesaplama"

Ne Yapmalı:
   1. "🚀 HESAPLA" butonuna tıklayın
   2. "Hesaplanıyor..." yazısını bekleyin (30-60 saniye)
   3. "✅ Hesaplama tamamlandı!" mesajını görün
   4. Aşağıda 2 tablo belirecek:
      - Özet Metrikler Tablosu
      - SAP Dosyası Önizleme

   5. "📥 SAP Dosyası İndir (CSV)" butonuna tıklayın
   6. Dosyayı bilgisayarınıza kaydedin

⏱️ Süre: 1-2 dakika
💡 İpucu: SAP dosyasını mutlaka indirin! Sisteme yükleyeceksiniz.

───────────────────────────────────────────────────────────────
📍 ADIM 5: RAPORLAR (İnceleme)
───────────────────────────────────────────────────────────────
Nerede: Sevkiyat → "📈 Raporlar"

Ne Yapmalı:
   1. "📦 Ürün Analizi" sekmesine tıklayın
   2. Tabloyu inceleyin (hangi ürüne ne kadar sevkiyat?)
   3. "🗺️ İl Bazında Harita" sekmesine tıklayın
   4. Haritayı inceleyin (mouse ile zoom yapabilirsiniz)
   5. İl seçerek detayları görün

⏱️ Süre: 5 dakika
💡 İpucu: Performans %'sine dikkat edin!
...
🫧 SEGMENTASYON EKRANI
───────────────────────────────────────────────────────────────
- Varsayılan aralıklar: 0-4, 5-8, 9-12, 12-15, 15-20, 20+
- Grafikleri inceleyebilirsiniz (opsiyonel)
- "💾 Segmentasyonu Kaydet" butonuna basın
- "Excel İndir" veya "ZIP İndir" ile dışa aktarabilirsiniz

🎲 HEDEF MATRİS EKRANI
───────────────────────────────────────────────────────────────
4 Tablo Var:
   1. Şişme Oranı (varsayılan: 0.5) - Şu anda kullanılmıyor
   2. Genleştirme Oranı (varsayılan: 1.0) - İhtiyacı artırır
   3. Min Oran (varsayılan: 1.0) - Minimum stok çarpanı
   4. Initial (varsayılan: 1.0) - Yeni ürün çarpanı

Nasıl Değiştirilir:
   • Hücreye ÇİFT tıklayın
   • Yeni değer yazın (örn: 0.8, 1.2, 1.5)
   • "💾 KAYDET" butonuna basın

🔢 SIRALAMA EKRANI
───────────────────────────────────────────────────────────────
- Her satırda 3 öncelik var: RPT, Initial, Min
- Dropdown'dan sırasını değiştirin
- "💾 KAYDET" butonuna basın

📐 HESAPLAMA EKRANI
───────────────────────────────────────────────────────────────
- Tek buton var: "🚀 HESAPLA"
- Tıklayın ve bekleyin
- Sonuçlar otomatik gösterilir

📈 RAPORLAR EKRANI
───────────────────────────────────────────────────────────────
4 Sekme:
   • 📦 Ürün Analizi: Ürün bazında sonuçlar
   • 🏪 Mağaza Analizi: (Yakında)
   • ⚠️ Satış Kaybı: (Yakında)
   • 🗺️ Harita: İl bazında görsel

Filtreleme:
   • "Min Sevkiyat" kutusuna sayı girin
   • "Min Mağaza Sayısı" kutusuna sayı girin
   • Tablo otomatik güncellenir

═══════════════════════════════════════════════════════════════
HIZLI BAŞLANGIÇ (5 DAKİKA)
═══════════════════════════════════════════════════════════════

1. Veri Yükleme → 5 dosyayı yükle (2 dk)
2. Segmentasyon → Kaydet butonuna bas (30 sn)
3. Hesaplama → Hesapla butonuna bas (1 dk)
4. SAP dosyasını indir (10 sn)
5. Raporları incele (1 dk)
...
✅ MUTLAKA YAPIN:
   • Veri yükleme → 5 dosya olmalı
   • Segmentasyon → Kaydet butonuna basın
   • Hesaplama → SAP dosyasını indirin

⚠️ OPSIYONEL:
   • Hedef Matris → Varsayılanları kullanabilirsiniz
   • Sıralama → Varsayılanları kullanabilirsiniz
   • Raporlar → İncelemek için

💡 İLK KULLANIMDA:
   • Hiçbir ayar değiştirmeyin
   • Sadece: Veri Yükle → Segmentasyon Kaydet → Hesapla
   • Sonra deneyim kazandıkça özelleştirin

═══════════════════════════════════════════════════════════════
YAYGIN SORULAR
═══════════════════════════════════════════════════════════════

S: Segmentasyon ne anlama geliyor?
C: Ürün ve mağazaları gruplara ayırma. Varsayılanı kullanın.

S: Hedef matris'i doldurmam gerekiyor mu?
C: Hayır. Varsayılan değerler yeterli.

S: Performans % ne demek?
C: Sevkiyat / İhtiyaç oranı. %100'e yakın = iyi.

S: SAP dosyasını nereye yükleyeceğim?
C: SAP ekibinize verin, onlar yükleyecek.

S: Her hafta tüm adımları tekrar mı edeceğim?
C: Evet ama hızlı: Veri Yükle → Hesapla → İndir (3 dk)
...
"""
    ...
    def create_pdf():
        try:
            ...
            c.drawString(2*cm, height - 2*cm, "Sevkiyat Modulu Kullanim Kilavuzu")
            ...
            for line in lines:
                ...
                # Türkçe karakterleri basitleştir
                line_clean = line.encode('ascii', 'ignore').decode('ascii')
                c.drawString(1*cm, y_position, line_clean[:100])  # Max 100 karakter
    ...
    with col1:
        ...
        st.download_button(
            label="📖 Help (TXT)",
            data=sevkiyat_kilavuz,
            file_name="sevkiyat_help.txt",
            mime="text/plain",
    ...
    with col2:
        ...
        if pdf_buffer:
            st.download_button(
                label="📖 Help (PDF)",
                data=pdf_buffer,
                file_name="sevkiyat_help.pdf",
                mime="application/pdf",
                use_container_width=True
            )
        else:
            st.info("PDF için reportlab kütüphanesi gerekli: pip install reportlab")
