...
# ============================================
    ...
    **Master Data Nedir?**
    ...
    if st.session_state.anlik_stok_satis is None:
        ...
        if st.button("🚀 Master Data Oluştur", type="primary", use_container_width=True, key="master_data_btn"):
            with st.spinner("📊 Master data hazırlanıyor..."):
                ...
                with col4:
                    ...
                    try:
                        ...
                        st.error("Parquet için pyarrow gerekli")
                ...
                with col2:
                    filtre_magaza = st.text_input("Mağaza Kodu Ara", "", key="filtre_magaza")
                
                with col3:
                    filtre_urun = st.text_input("Ürün Kodu Ara", "", key="filtre_urun")
