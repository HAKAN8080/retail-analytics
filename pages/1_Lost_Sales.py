...
# ============================================
    ...
    with st.expander("🔧 Gün Dağılım Ayarları", expanded=False):
        ...
        **Gün Dağılım:** Haftanın her gününün toplam haftalık satış içindeki payı.
        ...
        if st.button("💾 Gün Dağılımını Kaydet", width='stretch'):
            if abs(toplam_yuzde - 100.0) < 0.1:
        ...
        st.plotly_chart(fig_gun, width='stretch')
    ...
    # HESAPLA BUTONU
    if st.button("🚀 LOST SALES HESAPLA", type="primary", width='stretch'):
        try:
            ...
            if sk_kullanildi and 'stoklu_gun_orani' in kayip_df.columns:
                ...
                st.dataframe(pd.DataFrame(sk_ozet), width='stretch', hide_index=True)
            ...
            if 'proxy_fallback_tip' in kayip_df.columns:
                ...
                with col2:
                    st.dataframe(fallback_dist, width='stretch', hide_index=True)
...
# ============================================
    ...
    with tab1:
        ...
        st.dataframe(urun_grp.head(50), width='stretch', height=400)
    ...
    with tab2:
        ...
        st.dataframe(mag_grp.head(50), width='stretch', height=400)
    ...
    with tab4:
        ...
        if st.session_state.haftalik_trend is None:
            ...
            if 'tarih' in trend_df.columns:
                ...
                st.dataframe(haftalik, width='stretch', hide_index=True)
                ...
                st.plotly_chart(fig_oran, width='stretch')
